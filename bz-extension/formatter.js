...
:root {
  ...
  --success-color: #DFD;
  --failed-color: #FCC;
  --panel-background-color:#f3f7f9;
  --hover-background-color:#cce1ff;
  --high-color:yellow;
  --result-hover:#DDD;
  --tab-color:#EEE;
  --tab-bar-color:#d3dbde;
  --diff-color:#F99;
  --diff-color-1:#9F9;
  --diff-color-2:#FCC;
  --diff-color-3:#CFC;
...
@font-face {
  font-family: 'icomoon';
  src:  url('//ai.boozang.com/font2.0/icomoon.eot?3x065d');
  src:  url('//ai.boozang.com/font2.0/icomoon.eot?3x065d#iefix') format('embedded-opentype'),
    url('//ai.boozang.com/font2.0/icomoon.woff2?3x065d') format('woff2'),
    url('//ai.boozang.com/font2.0/icomoon.ttf?3x065d') format('truetype'),
    url('//ai.boozang.com/font2.0/icomoon.woff?3x065d') format('woff');
  font-weight: 100;
  font-style: normal;
  font-display: block;
}
...
.bz-log-box{
  ...
  border:2px solid var(--box-background-color) !important;
}
...
.bz-title .bz-result.bz-failed:hover{
  background-color:var(--result-hover) !important;
}
.bz-switch{
  width:30px;
  margin:0 5px;
...
.bz-tab-bar{
  border-bottom:1px solid var(--tab-bar-color) !important;
  display:flex;
}
.bz-tab{
  cursor:pointer;
...
.bz-diff-item1{
  background-color: var(--diff-color-1);
}
.bz-diff-item2{
  background-color: var(--diff-color-2);
}
.bz-diff-item12{
  background-color: var(--diff-color-3);
}
.bz-same-item{
  display:none;
}
...
.std:hover{
  background-color: var(--std-hover-color);
...
@media (prefers-color-scheme: dark) {
  :root {
    ...
    --success-color: #030;
    --failed-color: #300;
    --panel-background-color: #030709;
    --hover-background-color:#331e99;
    --high-color:#330;
    --result-hover:#333;
    --tab-color:#111;
    --tab-bar-color:#2C2421;
    --diff-color:#055;
    --diff-color-1:#505;
    --diff-color-2:#033;
    --diff-color-3:#303;
  ...
  .jenkins-button,*:not(svg,use,.bz-log-box *){
    color:#CCC !important;
